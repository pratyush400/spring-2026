...
prints the address of (1) a small global variable (e.g., a scalar), (2) a 
large global variable (e.g., a large array), (3) a local (i.e., declared inside
a function) variable, (4) a small dynamic allocation (e.g., 8 bytes), (5) a
large dynamic allocation (e.g., 100,000 bytes), (6) a function you defined, and
(5) a function available in a library (e.g., `malloc` or `printf`).
